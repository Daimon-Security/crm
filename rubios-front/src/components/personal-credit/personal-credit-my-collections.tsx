...
import { cancelRegisteredPayment, cancelRegisteredPaymentInterest, getById, getCollections, getCollectionsByClientName, getSearchCollections, registerCancellationInterestPrincipal, registerPayment, reschedulePayment, setClientId, setCreditSelected, setSelectedCollection } from "../../redux/slices/credit-slice";
...
export const PersonalCreditMyCollections = () => {
    const dispatch = useAppDispatch();
    const { collections, dateQuery, selectedCollection, type, paymentFrequencies, filterClientName, clientId } = useAppSelector((state: RootState) => state.credits);
...
export default PersonalCreditMyCollections;